...
require_once(app_path('includes\excel\spreadsheet\writer\Format.php'));
require_once(app_path('includes\excel\spreadsheet\writer\BIFFwriter.php'));
require_once(app_path('includes\excel\spreadsheet\writer\Worksheet.php'));
require_once(app_path('includes\excel\spreadsheet\writer\Parser.php'));
require_once(app_path('includes\excel\spreadsheet\ole\pps\Root.php'));
require_once(app_path('includes\excel\spreadsheet\ole\pps\File.php'));
