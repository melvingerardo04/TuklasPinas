...
#require_once '../includes/excel/spreadsheet/writer/Parser.php';
#require_once '../includes/excel/spreadsheet/writer/BIFFwriter.php';
    ...
    */
    function write($row, $col, $token, $format = null)
    {
        ...
        if (preg_match("/^([+-]?)(?=\d|\.\d)\d*(\.\d*)?([Ee]([+-]?\d+))?$/", $token)) {
            ...
            return $this->writeString($row, $col, utf8_decode($token), $format);
        }
    }
